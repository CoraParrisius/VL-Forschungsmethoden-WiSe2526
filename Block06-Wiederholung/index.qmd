...
> Bitte bearbeiten Sie das Liveexperiment (Masterarbeit) unter [https://ogy.de/mvl-25](https://ogy.de/mvl-25), anhand dessen Ergebnisse wir die Inhalte wiederholen werden. Unter den Datenspender:innen werden als symbolische Anerkennung zwei Einkaufsgutscheine im Wert von 10€ verlost.
...
data_new <- ds %>% 
  ...
  filter(start > ymd_hms("2025-07-22 09:00:00")) %>% 
...
::: {.column width='60%'}
 > Welches Pearson's $r$ erwarten Sie?
