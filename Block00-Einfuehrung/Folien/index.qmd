...
date: today
date-format: "[Wintersemester] YYYY"

logo: img/ph-logo.svg
footer: Folien by Samuel Merk {{< iconify streamline:creative-commons-solid >}} {{< iconify fa6-brands:creative-commons-by >}} unter ogy.de/mvl-wise-2526
...
![https://ogy.de/mvl-wise-2526](img/QR Code ogy-de-mvl-wise-2526.png){width=50%}
:::
...
* Tutorien finden wöchtenlich statt
* Termine starten kommende Woche
* Termine werden über InnovationSpace bekannt gegeben
* Tutor:innen: Nilani Suriakumar, Ruben Rothenhäusler, Ronja Barth, Lisa Mayer


## Studienleistung: Teilnahme an Experimenten {.smaller}

* insg. 5 Versuchspersonenstunden (VPS) für gesamtes Modul M2
  * Teilnahme an angebotenen Experimenten an Institut für Psychologie oder Institut für Empirische Bildungsforschung
  * Teilnahme wird jeweils mit vorab festgelegter VPS-Zahl honoriert
  * Sammeln von mind. 5 VPS **obligatorische** Studienleistung (Nicht-Erfüllung = Nicht-Bestehen)
  * Ersatzleistung möglich: Zusammenfassen von vorgegebenen Forschungsartikeln
  
  * Angebotene Studien zur Teilnahme: *Link folgt*


## Prüfungsleistung: Klausur {.smaller}
